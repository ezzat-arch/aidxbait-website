...
--   8. Blog module (009): posts + translations + items + related products,
--      public-read RLS policies, blog-images bucket
--   9. Blog related products from Shopify (010): post_shopify_products
--      replaces post_products
--  10. Security (002): enable RLS on ALL public tables (runs LAST)
--
...
-- ============================================================================
-- FROM: 010_blog_shopify_products.sql
-- ============================================================================
------------------------------------------------------------------------------
