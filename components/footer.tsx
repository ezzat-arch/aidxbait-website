    ...
    <footer className="bg-gray-900 text-gray-300">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <Link href="/" className="inline-block mb-6">
              <Image src="/images/logo-icon.png" alt="AidXBait Logo" width={50} height={50} className="h-12 w-auto" />
            </Link>
            <p className="mb-6 max-w-xs">
              Revolutionizing orthopedic care through technology, making recovery more accessible and effective.
            </p>
            <div className="flex gap-4">
              <Link href="#" className="p-2 bg-gray-800 rounded-full hover:bg-primary/20 transition-colors">
          ...
          <div>
            ...
            <p className="mb-6">Get the AidXBait app for iOS and Android to access all features on the go.</p>
      ...
      <div className="border-t border-gray-800 py-6">
        <div className="container flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm">© {new Date().getFullYear()} AidXBait. All rights reserved.</p>
