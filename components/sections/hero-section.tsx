		...
		<div className="flex flex-col">
			...
			>
				...
				<div className="container relative z-20 px-4 sm:px-6 lg:px-8 max-w-full overflow-x-hidden">
					<div className="grid gap-4 sm:gap-8 lg:grid-cols-2 lg:gap-16 items-center justify-items-center pt-16 sm:pt-20 md:pt-24 lg:pt-0 hero-content max-w-7xl mx-auto">
						<div className="overflow-x-hidden w-full flex ltr:lg:justify-end rtl:lg:justify-start justify-center">
							<motion.div
								...
								className="flex flex-col gap-4 sm:gap-6 text-center ltr:lg:text-left rtl:lg:text-right items-center ltr:lg:items-start rtl:lg:items-end ltr:lg:pr-4 rtl:lg:pl-4"
							>
						...
						<div className="w-full flex ltr:lg:justify-start rtl:lg:justify-end justify-center ltr:lg:pl-16 rtl:lg:pr-16 pb-6 lg:pb-8">
							<motion.div
								...
								transition={{ duration: 0.7 }}
								viewport={{ once: true, amount: 0.5 }}
								className="relative w-full max-w-xs sm:max-w-md md:max-w-lg h-[250px] sm:h-[300px] md:h-[350px] lg:h-[450px] mt-6 sm:mt-8 lg:mt-0 lg:animate-float hero-image-container"
							>
