        ...
        return (
                ...
                >
                        ...
                        <div className="mt-3 space-y-1 text-xs text-blue-700 dark:text-blue-300">
                                ...
                                <div className="font-medium text-blue-600 dark:text-blue-400">Avg. Age: 42 years</div>
        ...
        return (
                <motion.div className="flex h-full min-h-[6rem] w-full flex-1 flex-col justify-center rounded-lg bg-gradient-to-br from-green-50 to-green-100 p-4 dark:from-green-900/20 dark:to-green-800/20">
                        <div className="mb-4 text-center">
                                ...
                                <div className="text-sm text-green-700 dark:text-green-300">Licensed Professionals</div>
                        </div>
                ...
                <motion.div className="flex h-full min-h-[6rem] w-full flex-1 flex-col justify-center rounded-lg bg-gradient-to-br from-purple-50 to-purple-100 p-4 dark:from-purple-900/20 dark:to-purple-800/20">
                        ...
                        <div className="mb-2 flex h-16 justify-between">
                                {recoveryData.map((data, index) => (
                                        <div key={data.week} className="flex flex-col items-center space-y-1">
                                                ...
                                                <span className="text-xs text-purple-700 dark:text-purple-300">{data.week}</span>
                                        </div>
                                ))}
                        </div>
                        <div className="mb-3 flex justify-center space-x-3 text-xs">
                                ...
                                <div className="flex items-center space-x-1">
                                        ...
                                        <span className="text-purple-700 dark:text-purple-300">With AidXBait</span>
                                </div>
                        </div>
...
const AppDownloadsCard = () => {
        ...
        return (
                <motion.div className="flex h-full min-h-[6rem] w-full flex-1 flex-col justify-center rounded-lg bg-gradient-to-br from-teal-50 to-teal-100 p-4 text-center dark:from-teal-900/20 dark:to-teal-800/20">
                        <div className="mb-3 text-xl font-bold text-teal-600 dark:text-teal-400">5,000+ App Downloads</div>
                        ...
                        <div className="space-y-1 text-xs text-teal-600 dark:text-teal-400">
                                <div className="font-medium text-teal-700 dark:text-teal-300">⭐ 4.8/5 Rating</div>
        ...
        return (
                ...
                >
                        ...
                        >
                                ...
                                <div className="flex-1">
                                        <p className="mb-1 text-xs leading-tight text-neutral-500">
                                                AidXBait offers comprehensive physiotherapy services including home visits, exercise programs, and online consultations to help you recover faster...
                                        </p>
                        ...
                        <div className="mt-1 space-y-0.5 rounded-lg bg-neutral-50 p-2 dark:bg-neutral-800">
                                <p className="mb-1 text-xs text-neutral-600 dark:text-neutral-400">📊 Consultation Stats:</p>
                                <div className="space-y-0.5">
                                        <div className="flex justify-between text-xs">
                                                <span className="text-neutral-500">Home Visits:</span>
                                                <span className="font-medium text-neutral-700 dark:text-neutral-300">3,200+</span>
                                        </div>
                                        <div className="flex justify-between text-xs">
                                                <span className="text-neutral-500">Online Sessions:</span>
                                                <span className="font-medium text-neutral-700 dark:text-neutral-300">4,800+</span>
                                        </div>
                                        <div className="flex justify-between text-xs">
                                                <span className="text-neutral-500">Avg. Session Time:</span>
                                                <span className="font-medium text-neutral-700 dark:text-neutral-300">45 min</span>
                                        </div>
                                        <div className="flex justify-between text-xs">
                                                <span className="text-neutral-500">Patient Satisfaction:</span>
                                                <span className="font-medium text-neutral-700 dark:text-neutral-300">98%</span>
                                        </div>
                                </div>
                        </div>
                </motion.div>
...
const metrics = [
        {
                ...
                description: (
                        <div>
                                <span className="block text-sm">Over 10,000 patients have used AidXBait for their recovery.</span>
        ...
        },
        {
                ...
                description: (
                        <div>
                                <span className="block text-sm">500+ certified therapists available for home visits and consultations.</span>
                                <span className="mt-1 block text-xs text-neutral-500">
        ...
        },
        {
                ...
                description: (
                        <div>
                                <span className="block text-sm">Patients report 30% faster recovery with our programs.</span>
                                <span className="mt-1 block text-xs text-neutral-500">
        ...
        },
        {
                ...
                description: (
                        <div>
                                <span className="block text-sm">5,000+ downloads of our mobile app across iOS and Android.</span>
                                <span className="mt-1 block text-xs text-neutral-500">
        ...
        },
        {
                ...
                description: <span className="text-sm">8,000+ online and in-person consultations booked.</span>,
