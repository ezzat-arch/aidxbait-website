		...
		>
			...
			<div className="container relative z-20">
				<div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
					...
					>
						<h1 className="text-4xl text-white sm:text-5xl md:text-6xl font-bold tracking-tight">
							Revolutionizing{" "}
						...
						<div className="flex flex-col sm:flex-row gap-4 mt-4">
							<Button
								size="lg"
								className="bg-primary hover:bg-primary/90 text-white transition-all duration-500"
							>
							...
							<Button
								size="lg"
								variant="outline"
								className="border-white text-black hover:bg-white/10 transition-all duration-500"
							>
								Learn More
							</Button>
						</div>
					...
					>
						<div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-primary/20 to-primary/10 rounded-3xl transform rotate-3"></div>
