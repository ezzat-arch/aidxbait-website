...
export function AppDownloadSection() {
  return (
    <section id="app" className="py-20 bg-gradient-to-br from-primary to-accent text-white">
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Download the AidXBait App Today</h2>
            <p className="text-lg text-white/80 mb-8 max-w-xl">
              Take control of your orthopedic care journey with our comprehensive mobile application. Available for iOS
              and Android devices.
            </p>
            ...
            <div className="mt-12 flex flex-col gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">Monitor your recovery journey with detailed analytics</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="bg-white/20 p-3 rounded-full">
                ...
                <div>
                  ...
                  <p className="text-white/70">Schedule consultations with just a few taps</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="bg-white/20 p-3 rounded-full">
                ...
                <div>
                  <h4 className="font-medium">Personalized Exercise Protocols</h4>
                  <p className="text-white/70">Access customized therapy programs for your specific needs</p>
                </div>
              </div>
            </div>
          </div>
