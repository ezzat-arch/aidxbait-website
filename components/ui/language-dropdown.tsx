...
const UKFlag = () => (
	<svg viewBox="0 0 24 16" className="w-5 h-3.5 rounded-sm">
	...
	return (
		<DropdownMenu>
			<DropdownMenuTrigger asChild>
				<button
					className={cn(
						"inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-gradient-to-r from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 border border-blue-200 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-sm hover:shadow-md group",
						className
					)}
				>
			...
			<DropdownMenuContent
				align="end"
				className="min-w-[160px] bg-white/95 backdrop-blur-sm border border-gray-200 shadow-lg rounded-lg p-1"
				sideOffset={5}
			>
