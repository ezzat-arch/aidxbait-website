...
export const Skeleton = ({ icon }: { icon?: React.ReactNode }) => {
  const scale = [1, 1.1, 1];
  ...
  return (
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row shrink-0 justify-center items-center gap-4">
        <Container className="h-10 w-10 opacity-100">
          <Activity className="h-6 w-6 text-gray-400" />
        </Container>
        <Container className="h-14 w-14">
          {icon ? icon : <Video className="h-8 w-8 text-purple-600" />}
        </Container>
        <Container className="h-10 w-10 opacity-100">
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] bg-white/80 backdrop-blur-md shadow-[0_8px_32px_0_rgba(31,38,135,0.15),0_1.5px_6px_0_rgba(0,0,0,0.10)]",
        className
      )}
    >
      {children}
