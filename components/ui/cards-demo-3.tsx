...
export const Skeleton = ({ icon }: { icon?: React.ReactNode }) => {
	...
	return (
		<div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
			...
			{/* Animated line that moves from left to right */}
			<motion.div
				className="h-40 w-px absolute top-20 left-1/2 -translate-x-1/2 z-40 bg-gradient-to-b from-transparent via-cyan-500 to-transparent"
				initial={{ x: -200 }}
				animate={{ x: 200 }}
				transition={{
					duration: 4,
